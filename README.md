...
- **Tested native core:** the protocol and recovery implementation is pinned to [netft-cpp 0.3.2](https://github.com/netft/netft-cpp/releases/tag/v0.3.2) and is exercised with offline fake sensors and native sanitizers.
